    ...
    resources: {
      ...
      ar: {
        translation: {
          ...
          attr: "المرفقات المطلوبة (لا تتجاوز 15 ميغا)",
          attr1: " اخر شهادة جامعية أو ما يعادلها (PDF)",
          attr2: "صورة لجواز السفر/البطاقة الشخصية (PDF)",
          attr3: "السيرة الذاتية (PDF)",
          attr4: "أهم شهادات التدريب والخبرة إن وجدت(PDF)",
          attr5: "رسالة تزكية من مشرف العمل/الدراسة (PDF)",

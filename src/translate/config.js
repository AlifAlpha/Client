    ...
    resources: {
      ...
      ar: {
        translation: {
          ...
          /** Nomination */
          titln: "2022 ترشيح - عام الإيسيسكو للشباب",
          ...
          experience:
            "اذكر الخبرات المتصلة(تدريبات، تطوع، ..الخ) باختصاصات المنظمة التي تمتلكها",
          experienceinfo: "ما لا يزيد عن 150 كلمة ",

          info3: "اختياري/ المعلومات الوظيفية",
          currentField: "مجال العمل الحالي",
          currentWork: "الوظيفة لحالية",
          employer: "جهة العمل",
          workAddress: "عنوان العمل",
          employerPhone: "هاتف جهة العمل",
          employerWebsite: "الموقع الالكتروني لجهة العمل",
          employerEmail: "البريد الالكتروني لجهة العمل",
...
يتحمل المترشح كامل المسؤولية القانونية عن صحة الوثائق المرفقة و دقتها
`,
        },
      },
      fr: {
